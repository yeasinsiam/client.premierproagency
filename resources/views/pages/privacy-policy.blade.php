@extends('layout.main')
@section('meta-title', 'Privacy Policy - PremierPro Agency')
{{-- @section('navbar-styles', 'background-color: var(--header-bg-color);') --}}
@section('content')
    <div class="navbar-holder"></div>
    <section style="padding: 130px 0;padding-top: 50px">
        <div class="container">
            <h1>Privacy Policy for PremierPro Agency</h1>

            <p>At PremierPro Agency, accessible from https://premierproagency.com, one of our main priorities is the
                privacy of
                our visitors. This Privacy Policy document contains types of information that is collected and recorded by
                PremierPro Agency and how we use it.</p>
            ...
            <p>This Privacy Policy applies only to our online activities and is valid for visitors to our website with
                regards
                to the information that they shared and/or collect in PremierPro Agency. This policy is not applicable to
                any
            ...
            <p>PremierPro Agency follows a standard procedure of using log files. These files log visitors when they visit
            ...
            <P>You may consult this list to find the Privacy Policy for each of the advertising partners of PremierPro
                Agency.
            </p>

            <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are
                used in
                their respective advertisements and links that appear on PremierPro Agency, which are sent directly to
                users'
            ...
            <p>Note that PremierPro Agency has no access to or control over these cookies that are used by third-party
                advertisers.</p>

            <h2>Third Party Privacy Policies</h2>

            <p>PremierPro Agency's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you
                to
            ...
            <p>PremierPro Agency does not knowingly collect any Personal Identifiable Information from children under the
                age of
