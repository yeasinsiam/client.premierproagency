            ...
            if (inview) {
                $(item).each(function () {
                    ...
                    $(this)
                        ...
                        .on(
                            "radial-animation-progress",
                            function (event, progress) {
                                $(this)
                                    .find("span")
                                    .html(
                                        Math.round(percent * progress) + symbol
                                    );
                            }
                        );
                });
...
/*----------------------------------------------
13. Portfolio Light gallery
----------------------------------------------*/

jQuery(function ($) {
    "use strict";

    $(".portfolio-section .mid-slider").each(function () {
        ...
        swiper.on("init", () => {
            const lg = $(this).lightGallery({
                thumbnail: false,
                share: false,
                selector: $(this).find(".gallery-image"),
            });
            console.log(lg);
